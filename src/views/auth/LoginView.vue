    ...
    <v-container class="auth-container fill-height pa-0">
      <v-row no-gutters class="fill-height">
          ...
          <div class="brand-content d-flex flex-column justify-center">
            <div class="text-center">
              ...
              <p class="text-h6 text-white mb-8 mx-auto" style="max-width: 500px">
                Your digital library management system for easy book borrowing and returns
              </p>
              <v-card
              ...
              >
                <v-card-text class="text-white">
                  ...
                  <p class="text-right text-caption mt-2">— George R.R. Martin</p>
                </v-card-text>
              </v-card>
            </div>
          </div>
        ...
        <v-col cols="12" md="6" class="form-panel d-flex align-center justify-center">
          <v-sheet class="login-form mx-auto" max-width="480" rounded="lg" elevation="0">
            <div class="d-flex d-md-none justify-center mb-6">
              <v-img src="/public/images/lbb.png" max-width="80" alt="Logo"></v-img>
            </div>

            <h2 class="text-h4 font-weight-bold mb-2 text-center">Welcome Back</h2>
            <p class="text-subtitle-1 text-medium-emphasis text-center mb-8">
              Log in to continue to Book Borrow
            </p>
            ...
            <div class="text-center mt-6">
              ...
              <RouterLink class="text-cyan-darken-1 font-weight-medium" to="/register">
                Create Account
              </RouterLink>
            </div>
          </v-sheet>
